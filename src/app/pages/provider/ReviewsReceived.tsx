        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
          <Card className="border-border p-5 lg:p-6">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl lg:text-[32px] font-semibold">{stats.avg}</span>
          ...
          <Card className="border-border p-5 lg:p-6">
            ...
            <div className="text-2xl lg:text-[32px] font-semibold">{stats.total}</div>
          </Card>
          <Card className="border-primary bg-primary/5 p-5 lg:p-6">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl lg:text-[32px] font-semibold">{stats.fiveStarCount}</span>
